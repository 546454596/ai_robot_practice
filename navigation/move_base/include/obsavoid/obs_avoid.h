...
//      void goalCB(const geometry_msgs::PoseStamped::ConstPtr& goal);
        ...
        void obs_abortCB(const std_msgs::Bool::ConstPtr &_msg);
...
//        void executeCb(const move_base_msgs::MoveBaseGoalConstPtr& move_base_goal);
        ...
        boost::shared_ptr<nav_core::BaseLocalPlanner> lc_;
...
//      boost::shared_ptr<nav_core::BaseGlobalPlanner> planner_;
        ...
        ros::Publisher vel_pub_, action_goal_pub_, recovery_status_pub_;
        ros::Subscriber goal_sub_;
        ros::ServiceServer make_plan_srv_, clear_costmaps_srv_;
        ros::Subscriber path_sub, joy_sub, joy_sub2, obs_abort;
        bool pub_zero_velocity;
